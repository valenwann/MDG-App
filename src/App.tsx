...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans selection:bg-[#FF6A00] selection:text-white">
      {/* --- TOP NAVIGATION --- */}
      <nav className="bg-white border-b-2 border-stone-100 sticky top-0 z-[60] py-4">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col cursor-pointer" onClick={() => {setShowPortfolio(false); setShowAdmin(false);}}>
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-stone-400 mt-1 italic italic">Humble Stories • Global Perspective</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            <button onClick={() => setShowPortfolio(true)} className="text-xs font-black uppercase tracking-widest hover:text-[#FF6A00] transition-colors border-b-2 border-transparent hover:border-[#FF6A00] pb-1 italic">Portfolio</button>
          </div>
        </div>
      </nav>
        ...
        <main className="max-w-7xl mx-auto px-6 py-12">
          ...
          <section className="mb-32">
            <div className="flex items-center justify-between mb-16 border-b-4 border-stone-100 pb-8">
              ...
              <span className="bg-stone-50 text-stone-400 px-6 py-2 rounded-full font-bold text-xs uppercase tracking-widest border border-stone-100 italic italic">Global • {language}</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[1, 2, 3].map(i => (
                <div key={i} className="group cursor-pointer">
                  ...
                  <p className="text-[#FF6A00] font-black uppercase text-xs tracking-widest mb-4 italic">Insight Vol. {i}</p>
                  <h4 className="text-3xl font-black leading-none uppercase tracking-tighter group-hover:text-[#FF6A00] transition-colors italic">Real human stories that travel across borders.</h4>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="bg-stone-50 border-4 border-stone-100 p-12 md:p-24 rounded-[5rem] mb-32 text-center">
            ...
            <p className="text-stone-500 text-2xl md:text-4xl leading-tight mb-16 max-w-5xl mx-auto italic font-medium leading-relaxed">
            ...
            <p className="text-stone-300 uppercase font-black text-xs tracking-[0.6em] italic">Real Stories. Practical Insight. Global Perspective.</p>
          </section>
        </main>
      ) : (
        /* --- PORTFOLIO PAGE --- */
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
             <div className="space-y-12">
                ...
                <div className="space-y-8 italic">
                   <p className="text-2xl font-bold text-stone-600 leading-tight">01 / Human-Centered: Complex topics made simple and warm.</p>
                   <p className="text-2xl font-bold text-stone-600 leading-tight">02 / Psychology-Led: Understanding what moves global audiences.</p>
                   <p className="text-2xl font-bold text-stone-600 leading-tight">03 / Cross-Cultural: Bridging the gap between Africa & Europe.</p>
                </div>
             </div>
             <div className="bg-[#FF6A00] p-12 rounded-[4rem] text-white shadow-2xl">
                <h3 className="text-3xl font-black uppercase italic mb-8 tracking-tighter">Let's Partner</h3>
                <p className="text-xl mb-10 font-bold leading-relaxed opacity-90 italic">I help brands and publications tell stories that resonate across borders. High-ticket reports, blog series, or localized strategy.</p>
      ...
      <footer className="bg-white border-t-2 border-stone-100 py-32 text-center">
        <h2 className="text-2xl font-black uppercase italic mb-12 text-stone-200">The Modern Dispatch <span className="text-stone-300">Global</span></h2>
        ...
        <div className="fixed inset-0 z-[100] bg-white/98 backdrop-blur-3xl p-4 md:p-10 overflow-y-auto flex items-center justify-center">
          <div className="max-w-6xl w-full bg-white border-[12px] border-stone-100 rounded-[5rem] overflow-hidden shadow-2xl">
            <div className="p-12 border-b-8 border-stone-50 flex items-center justify-between bg-stone-50/30">
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-bold uppercase text-stone-400 tracking-[0.5em] mt-3 italic italic italic">Global Engine • Katalena Status: Primed</p>
                </div>
              </div>
            ...
            <div className="p-12 lg:p-20 space-y-12">
              ...
              {[
                { time: '23:00 - 01:00', task: 'International Night Shift', detail: 'Primary Global sync. Transform stories to DE/ES/FR. Apply Human Instinct Protocol (Local Humor & Tone).', icon: Globe },
                { time: '09:00 - 12:00', task: 'Main Editorial Block', detail: 'Draft 2,500 word anchor story. Humour, Real Life Examples & Humble Blog Tone.', icon: Palette },
                { time: '13:00 - 15:00', task: 'Repurposing Cycle', detail: 'Transcription of high-value global media into humanized blog posts.', icon: TrendingUp },
                { time: '16:00 - 18:00', task: 'Optimized Distribution', detail: 'Publishing at peak morning engagement for EU & African audiences.', icon: Target },
              ].map((item, idx) => (
                <div key={idx} className="flex items-center gap-12 p-12 bg-stone-50/50 border-4 border-stone-100 rounded-[4rem] group hover:border-[#FF6A00] transition-all transform hover:-translate-x-2">
                  <span className="text-stone-300 font-black text-3xl tabular-nums w-56 italic leading-none">{item.time}</span>
                  ...
                  <div>
                    <p className="font-black text-4xl mb-2 uppercase text-stone-900 tracking-tighter italic leading-none">{item.task}</p>
                    <p className="text-stone-400 text-xl italic leading-relaxed font-medium">{item.detail}</p>
                  </div>
                </div>
              ))}
            </div>
